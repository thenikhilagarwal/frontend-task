...
export default function App() {
  ...
  // Clear all campaigns to return to the screenshot empty state
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8] dark:bg-slate-950 flex transition-colors duration-200">
      {/* Sidebar navigation */}
      <Sidebar
        theme={theme}
        setTheme={setTheme}
      ...
      {/* Main Container */}
      <div className="flex-1 flex flex-col min-w-0 pt-3 px-5">
        {/* Header toolbar */}
        <Header />

        {/* Content Viewport */}
        <main className="flex-1 p-8 bg-white dark:bg-slate-900 my-6 w-full mx-auto space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="relative sm:w-56">
                <button
                  ...
                  className="w-full w-full px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md flex items-center justify-between text-sm font-semibold text-slate-700 dark:text-slate-350 hover:bg-slate-50 dark:hover:bg-slate-800/80 transition-all cursor-pointer shadow-xs select-none"
                >
