...
export default function Sidebar({ theme, setTheme, activeTab, setActiveTab }) {
  ...
  return (
    <aside className={`relative border-r border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col justify-between h-screen sticky top-0 transition-all duration-300 select-none ${isSidebarCollapsed ? 'activeSidebar w-15' : 'w-64 '}`}>
      {/* Top Brand Header */}
      <div>
