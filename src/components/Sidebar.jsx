...
export default function Sidebar({ theme, setTheme, activeTab, setActiveTab }) {
  return (
    <aside className="w-64 border-r border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col justify-between h-screen sticky top-0 transition-colors duration-200 select-none">
      {/* Top Brand Header */}
      <div>
        <div className="flex items-center justify-between px-4 py-5">
          ...
          <button className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 cursor-pointer p-1 rounded-md hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
        ...
        <nav className="p-4 space-y-1">
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm font-medium text-sm transition-all duration-150 cursor-pointer ${activeTab === 'campaign'
